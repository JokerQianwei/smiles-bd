...
from smiles_bd.utils import load_checkpoint, sdpa_kernel_ctx
...
def main():
    ...
    prefix_ids = torch.tensor(
        tok.encode(args.prefix, add_special_tokens=False, max_length=cfg["model"]["max_len"], padding=False, truncation=True),
